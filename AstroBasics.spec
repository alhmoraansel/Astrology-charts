...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['queue', 'main', 'urllib.error', 'hashlib', 'warnings', 'save_prefs', 'json', 'astro_engine', 'PyQt6.QtCore', 'threading', 'importlib', 'PyQt6.QtWidgets', 'pickle', 'urllib.request', 'dynamic_settings_modules.composite_strength_mod', 'datetime', 'swisseph', 'time', 'sys', 'traceback', 'builtins', 'subprocess', 'PyQt6.QtGui', 'rectification_engine', 'dynamic_settings_modules', 'logging', 'os', 'math', 'copy', 'chart_renderer', 'dateutil.relativedelta', 'timezonefinder'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
