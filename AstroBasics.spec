...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['datetime', 'PyQt6.QtGui', 'logging', 'rectification_engine', 'warnings', 'main', 'astro_engine', 'dateutil.relativedelta', 'dynamic_settings_modules', 'os', 'copy', 'sys', 'subprocess', 'threading', 'swisseph', 'chart_renderer', 'importlib', 'hashlib', 'builtins', 'PyQt6.QtWidgets', 'time', 'math', 'pickle', 'urllib.error', 'traceback', 'timezonefinder', 'save_prefs', 'urllib.request', 'PyQt6.QtCore', 'queue', 'json'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
