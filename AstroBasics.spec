...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['builtins', 'swisseph', 'os', 'sys', 'queue', 'traceback', 'main', 'math', 'astro_engine', 'json', 'threading', 'logging', 'dynamic_settings_modules', 'copy', 'datetime', 'time', 'PyQt6.QtWidgets', 'pickle', 'urllib.error', 'save_prefs', 'dynamic_settings_modules.composite_strength_mod', 'timezonefinder', 'subprocess', 'PyQt6.QtCore', 'PyQt6.QtGui', 'urllib.request', 'warnings', 'dateutil.relativedelta', 'hashlib', 'importlib', 'chart_renderer', 'rectification_engine'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
