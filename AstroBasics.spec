...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['json', 'logging', 'astro_engine', 'hashlib', 'queue', 'save_prefs', 'main', 'PyQt6.QtWidgets', 'copy', 'subprocess', 'urllib.error', 'rectification_engine', 'time', 'warnings', 'PyQt6.QtCore', 'builtins', 'urllib.request', 'os', 'dynamic_settings_modules.composite_strength_mod', 'importlib', 'sys', 'dateutil.relativedelta', 'pickle', 'swisseph', 'traceback', 'threading', 'dynamic_settings_modules', 'math', 'timezonefinder', 'datetime', 'chart_renderer', 'PyQt6.QtGui'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
