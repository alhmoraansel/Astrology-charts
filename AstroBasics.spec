...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['dynamic_settings_modules', 'logging', 'swisseph', 'traceback', 'dateutil.relativedelta', 'copy', 'builtins', 'pickle', 'hashlib', 'queue', 'math', 'save_prefs', 'timezonefinder', 'PyQt6.QtWidgets', 'warnings', 'json', 'dynamic_settings_modules.composite_strength_mod', 'threading', 'PyQt6.QtGui', 'urllib.error', 'PyQt6.QtCore', 'main', 'sys', 'time', 'datetime', 'chart_renderer', 'importlib', 'subprocess', 'astro_engine', 'os', 'rectification_engine', 'urllib.request'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
