...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['pickle', 'math', 'urllib.request', 'importlib', 'save_prefs', 'dynamic_settings_modules', 'PyQt6.QtCore', 'dateutil.relativedelta', 'copy', 'main', 'builtins', 'logging', 'PyQt6.QtWidgets', 'astro_engine', 'warnings', 'time', 'dynamic_settings_modules.composite_strength_mod', 'json', 'subprocess', 'rectification_engine', 'traceback', 'os', 'datetime', 'hashlib', 'chart_renderer', 'swisseph', 'queue', 'sys', 'PyQt6.QtGui', 'timezonefinder', 'urllib.error', 'threading'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
