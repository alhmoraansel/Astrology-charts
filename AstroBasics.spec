...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['dateutil.relativedelta', 'queue', 'urllib.error', 'main', 'time', 'urllib.request', 'sys', 'warnings', 'swisseph', 'threading', 'PyQt6.QtGui', 'traceback', 'datetime', 'hashlib', 'timezonefinder', 'logging', 'astro_engine', 'math', 'json', 'subprocess', 'PyQt6.QtCore', 'os', 'PyQt6.QtWidgets'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
