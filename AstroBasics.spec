...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['chart_renderer', 'PyQt6.QtWidgets', 'threading', 'subprocess', 'save_prefs', 'dynamic_settings_modules', 'warnings', 'sys', 'json', 'swisseph', 'main', 'urllib.request', 'hashlib', 'os', 'dateutil.relativedelta', 'copy', 'importlib', 'astro_engine', 'dynamic_settings_modules.composite_strength_mod', 'rectification_engine', 'timezonefinder', 'math', 'traceback', 'time', 'queue', 'logging', 'pickle', 'urllib.error', 'PyQt6.QtGui', 'PyQt6.QtCore', 'datetime', 'builtins'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
