...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['save_prefs', 'logging', 'subprocess', 'PyQt6.QtCore', 'time', 'swisseph', 'queue', 'PyQt6.QtWidgets', 'timezonefinder', 'threading', 'dynamic_settings_modules', 'importlib', 'chart_renderer', 'traceback', 'os', 'dateutil.relativedelta', 'math', 'copy', 'dynamic_settings_modules.composite_strength_mod', 'builtins', 'datetime', 'main', 'astro_engine', 'urllib.request', 'hashlib', 'json', 'PyQt6.QtGui', 'rectification_engine', 'urllib.error', 'pickle', 'sys', 'warnings'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
