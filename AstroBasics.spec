...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['PyQt6.QtGui', 'PyQt6.QtWidgets', 'queue', 'urllib.error', 'dynamic_settings_modules', 'builtins', 'time', 'chart_renderer', 'json', 'main', 'os', 'hashlib', 'subprocess', 'timezonefinder', 'swisseph', 'urllib.request', 'astro_engine', 'math', 'logging', 'threading', 'traceback', 'copy', 'datetime', '__main__', 'dateutil.relativedelta', 'save_prefs', 'warnings', 'importlib', 'PyQt6.QtCore', 'sys'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
