...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['subprocess', 'chart_renderer', 'importlib', 'PyQt6.QtGui', 'urllib.request', 'datetime', 'os', 'sys', 'PyQt6.QtWidgets', 'astro_engine', 'urllib.error', 'timezonefinder', 'PyQt6.QtCore', 'threading', 'swisseph', 'queue', 'save_prefs', 'main', '__main__', 'traceback', 'logging', 'dynamic_settings_modules', 'dateutil.relativedelta', 'copy', 'hashlib', 'builtins', 'time', 'math', 'json', 'warnings'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
