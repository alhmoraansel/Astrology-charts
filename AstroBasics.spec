...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['time', 'swisseph', 'sys', 'threading', 'PyQt6.QtWidgets', 'astro_engine', 'hashlib', 'urllib.error', 'dateutil.relativedelta', 'datetime', 'queue', 'urllib.request', 'json', 'PyQt6.QtCore', 'subprocess', 'main', 'warnings', 'traceback', 'logging', 'timezonefinder', 'os', 'math', 'PyQt6.QtGui'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
