...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['copy', 'urllib.error', 'warnings', 'json', 'astro_engine', 'chart_renderer', 'os', 'importlib', 'main', 'PyQt6.QtCore', 'hashlib', 'traceback', 'logging', 'queue', 'dynamic_settings_modules', 'urllib.request', 'builtins', 'datetime', 'math', 'save_prefs', 'PyQt6.QtGui', 'PyQt6.QtWidgets', 'threading', 'time', 'swisseph', 'timezonefinder', 'subprocess', 'dateutil.relativedelta', '__main__', 'sys'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
