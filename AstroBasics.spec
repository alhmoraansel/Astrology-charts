...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['time', 'urllib.error', 'chart_renderer', 'importlib', 'datetime', 'astro_engine', 'hashlib', 'subprocess', 'PyQt6.QtWidgets', 'dynamic_settings_modules', 'sys', 'main', 'math', 'save_prefs', 'warnings', 'PyQt6.QtGui', 'swisseph', 'timezonefinder', 'rectification_engine', 'dynamic_settings_modules.composite_strength_mod', 'traceback', 'pickle', 'urllib.request', 'copy', 'PyQt6.QtCore', 'threading', 'queue', 'json', 'builtins', 'os', 'dateutil.relativedelta', 'logging'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
