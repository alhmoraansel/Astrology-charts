...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['rectification_engine', 'logging', 'astro_engine', 'PyQt6.QtWidgets', 'datetime', 'queue', 'timezonefinder', 'PyQt6.QtGui', 'dynamic_settings_modules', 'dateutil.relativedelta', 'traceback', 'time', 'warnings', 'hashlib', 'chart_renderer', 'main', 'pickle', 'subprocess', 'copy', 'threading', 'dynamic_settings_modules.composite_strength_mod', 'PyQt6.QtCore', 'sys', 'save_prefs', 'urllib.error', 'json', 'os', 'math', 'builtins', 'swisseph', 'urllib.request', 'importlib'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
