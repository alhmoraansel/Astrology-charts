...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['datetime', 'dateutil.relativedelta', 'traceback', 'time', 'sys', 'math', 'logging', 'builtins', 'hashlib', 'PyQt6.QtGui', 'urllib.request', 'json', 'swisseph', 'copy', 'queue', 'astro_engine', 'chart_renderer', 'subprocess', 'urllib.error', 'importlib', 'dynamic_settings_modules', 'warnings', 'PyQt6.QtWidgets', 'timezonefinder', 'save_prefs', '__main__', 'main', 'os', 'PyQt6.QtCore', 'threading'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
