...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['time', 'PyQt6.QtWidgets', 'warnings', 'swisseph', 'json', 'dynamic_settings_modules', 'sys', 'pickle', 'save_prefs', 'threading', 'dynamic_settings_modules.composite_strength_mod', 'os', 'traceback', 'chart_renderer', 'subprocess', 'rectification_engine', 'PyQt6.QtGui', 'dateutil.relativedelta', 'importlib', 'builtins', 'astro_engine', 'datetime', 'urllib.error', 'PyQt6.QtCore', 'queue', 'math', 'copy', 'urllib.request', 'main', 'timezonefinder', 'hashlib', 'logging'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
