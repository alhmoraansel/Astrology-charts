...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['copy', 'astro_engine', 'importlib', 'chart_renderer', 'main', 'subprocess', 'math', 'save_prefs', 'PyQt6.QtCore', 'dynamic_settings_modules', 'warnings', 'PyQt6.QtGui', 'PyQt6.QtWidgets', 'logging', '__main__', 'datetime', 'os', 'json', 'urllib.error', 'sys', 'urllib.request', 'dateutil.relativedelta', 'swisseph', 'time', 'traceback', 'builtins', 'threading', 'timezonefinder', 'hashlib', 'queue'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
