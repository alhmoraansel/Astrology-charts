...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['hashlib', 'sys', 'threading', 'copy', 'chart_renderer', 'urllib.error', 'subprocess', 'dynamic_settings_modules', 'save_prefs', 'urllib.request', 'builtins', 'traceback', 'datetime', '__main__', 'logging', 'math', 'PyQt6.QtGui', 'PyQt6.QtCore', 'warnings', 'timezonefinder', 'importlib', 'dateutil.relativedelta', 'main', 'astro_engine', 'json', 'swisseph', 'PyQt6.QtWidgets', 'time', 'os', 'queue'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
