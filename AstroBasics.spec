...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['dynamic_settings_modules', 'timezonefinder', 'dateutil.relativedelta', 'urllib.request', 'chart_renderer', 'queue', 'save_prefs', 'astro_engine', 'copy', 'PyQt6.QtCore', 'hashlib', 'importlib', 'swisseph', 'warnings', 'time', 'threading', 'PyQt6.QtWidgets', 'math', 'urllib.error', 'logging', 'main', 'PyQt6.QtGui', 'dynamic_settings_modules.composite_strength_mod', 'builtins', 'pickle', 'os', 'rectification_engine', 'sys', 'datetime', 'json', 'subprocess', 'traceback'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
