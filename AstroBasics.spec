...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['subprocess', 'PyQt6.QtCore', 'swisseph', 'os', 'traceback', 'urllib.error', 'dynamic_settings_modules', 'math', 'hashlib', 'builtins', 'json', 'queue', 'PyQt6.QtWidgets', 'datetime', '__main__', 'dateutil.relativedelta', 'urllib.request', 'warnings', 'timezonefinder', 'sys', 'chart_renderer', 'main', 'copy', 'save_prefs', 'time', 'importlib', 'logging', 'PyQt6.QtGui', 'threading', 'astro_engine'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
