...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['rectification_engine', 'copy', 'dynamic_settings_modules', 'hashlib', 'os', 'warnings', 'datetime', 'queue', 'importlib', 'pickle', 'threading', 'subprocess', 'dateutil.relativedelta', 'chart_renderer', 'json', 'astro_engine', 'PyQt6.QtGui', 'save_prefs', 'urllib.error', 'time', 'dynamic_settings_modules.composite_strength_mod', 'math', 'swisseph', 'timezonefinder', 'traceback', 'main', 'builtins', 'urllib.request', 'sys', 'logging', 'PyQt6.QtCore', 'PyQt6.QtWidgets'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
