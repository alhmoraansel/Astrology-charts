...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['PyQt6.QtGui', 'logging', 'traceback', 'threading', 'PyQt6.QtCore', 'main', 'dateutil.relativedelta', 'rectification_engine', 'dynamic_settings_modules', 'time', 'builtins', 'urllib.request', 'warnings', 'queue', 'swisseph', 'datetime', 'astro_engine', 'PyQt6.QtWidgets', 'save_prefs', 'pickle', 'hashlib', 'urllib.error', 'math', 'timezonefinder', 'subprocess', 'os', 'chart_renderer', 'sys', 'json', 'importlib', 'copy'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
