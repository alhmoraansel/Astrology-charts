...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['hashlib', 'chart_renderer', 'json', 'os', 'save_prefs', 'sys', 'main', 'builtins', 'queue', 'timezonefinder', 'swisseph', 'urllib.error', 'traceback', 'PyQt6.QtCore', 'datetime', 'dateutil.relativedelta', 'importlib', 'math', 'threading', 'dynamic_settings_modules', 'PyQt6.QtWidgets', 'time', 'urllib.request', 'logging', 'subprocess', 'copy', '__main__', 'warnings', 'astro_engine', 'PyQt6.QtGui'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
