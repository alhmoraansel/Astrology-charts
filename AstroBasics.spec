...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['hashlib', 'json', 'save_prefs', 'rectification_engine', 'urllib.error', 'traceback', 'PyQt6.QtGui', 'time', 'urllib.request', 'timezonefinder', 'pickle', 'astro_engine', 'swisseph', 'datetime', 'sys', 'logging', 'math', 'dateutil.relativedelta', 'dynamic_settings_modules', 'main', 'chart_renderer', 'subprocess', 'builtins', 'os', 'PyQt6.QtWidgets', 'queue', 'importlib', 'warnings', 'PyQt6.QtCore', 'dynamic_settings_modules.composite_strength_mod', 'threading', 'copy'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
