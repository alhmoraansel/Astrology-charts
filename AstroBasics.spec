...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['dateutil.relativedelta', 'hashlib', 'urllib.request', 'dynamic_settings_modules', 'os', 'astro_engine', 'PyQt6.QtGui', 'builtins', 'datetime', 'json', 'save_prefs', 'swisseph', 'copy', 'importlib', 'pickle', 'PyQt6.QtWidgets', 'chart_renderer', 'rectification_engine', 'queue', 'sys', 'timezonefinder', 'logging', 'warnings', 'urllib.error', 'traceback', 'time', 'main', 'subprocess', 'math', 'PyQt6.QtCore', 'threading'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
