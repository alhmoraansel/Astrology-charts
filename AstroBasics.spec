...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['timezonefinder', 'dateutil.relativedelta', 'astro_engine', 'PyQt6.QtGui', 'urllib.request', 'queue', 'logging', 'hashlib', 'time', 'threading', 'subprocess', 'PyQt6.QtCore', 'main', 'os', 'urllib.error', 'math', 'sys', 'datetime', 'json', 'warnings', 'traceback', 'swisseph', 'PyQt6.QtWidgets'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
