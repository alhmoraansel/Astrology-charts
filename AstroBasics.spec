...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['subprocess', 'rectification_engine', 'logging', 'copy', 'chart_renderer', 'urllib.error', 'warnings', 'PyQt6.QtCore', 'urllib.request', 'pickle', 'time', 'dynamic_settings_modules', 'PyQt6.QtGui', 'timezonefinder', 'json', 'builtins', 'save_prefs', 'os', 'astro_engine', 'datetime', 'importlib', 'sys', 'PyQt6.QtWidgets', 'dateutil.relativedelta', 'swisseph', 'hashlib', 'threading', 'queue', 'main', 'math', 'traceback'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
