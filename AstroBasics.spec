...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['swisseph', 'PyQt6.QtWidgets', 'timezonefinder', 'datetime', 'chart_renderer', '__main__', 'main', 'PyQt6.QtGui', 'PyQt6.QtCore', 'importlib', 'save_prefs', 'logging', 'warnings', 'copy', 'hashlib', 'sys', 'math', 'dynamic_settings_modules', 'builtins', 'json', 'urllib.request', 'dateutil.relativedelta', 'threading', 'traceback', 'time', 'urllib.error', 'os', 'queue', 'astro_engine', 'subprocess'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
