...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['time', 'json', 'urllib.error', 'PyQt6.QtGui', 'traceback', 'threading', 'hashlib', 'queue', 'PyQt6.QtWidgets', 'rectification_engine', 'dynamic_settings_modules', 'logging', 'urllib.request', 'datetime', 'save_prefs', 'main', 'swisseph', 'chart_renderer', 'pickle', 'subprocess', 'PyQt6.QtCore', 'dynamic_settings_modules.composite_strength_mod', 'os', 'sys', 'warnings', 'timezonefinder', 'builtins', 'math', 'astro_engine', 'copy', 'importlib', 'dateutil.relativedelta'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
