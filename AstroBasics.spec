...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['sys', 'subprocess', 'main', 'astro_engine', 'timezonefinder', 'urllib.error', 'PyQt6.QtGui', 'PyQt6.QtWidgets', 'threading', 'urllib.request', 'datetime', 'traceback', 'logging', 'queue', 'dateutil.relativedelta', 'time', 'swisseph', 'hashlib', 'PyQt6.QtCore', 'warnings', 'json', 'math', 'os'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
