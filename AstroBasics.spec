...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['sys', 'PyQt6.QtCore', 'json', 'urllib.request', 'datetime', 'threading', 'hashlib', 'os', 'warnings', 'main', 'astro_engine', 'math', 'dateutil.relativedelta', 'logging', 'queue', 'subprocess', 'traceback', 'swisseph', 'PyQt6.QtGui', 'PyQt6.QtWidgets', 'timezonefinder', 'time', 'urllib.error'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
