...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['threading', 'PyQt6.QtWidgets', 'math', 'queue', 'urllib.error', 'warnings', 'traceback', 'urllib.request', 'PyQt6.QtGui', 'logging', 'subprocess', 'datetime', 'os', 'dateutil.relativedelta', 'time', 'hashlib', 'timezonefinder', 'astro_engine', 'json', 'sys', 'swisseph', 'main', 'PyQt6.QtCore'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
