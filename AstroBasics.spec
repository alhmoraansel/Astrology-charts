...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['dynamic_settings_modules', 'timezonefinder', 'builtins', 'hashlib', 'os', 'time', 'main', 'datetime', 'sys', 'math', 'PyQt6.QtGui', 'urllib.request', 'traceback', 'logging', 'dateutil.relativedelta', 'astro_engine', 'queue', 'PyQt6.QtCore', 'threading', 'PyQt6.QtWidgets', 'warnings', 'save_prefs', 'json', '__main__', 'urllib.error', 'copy', 'subprocess', 'chart_renderer', 'swisseph', 'importlib'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
