...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['time', 'urllib.error', 'swisseph', 'logging', 'chart_renderer', 'traceback', 'astro_engine', 'PyQt6.QtCore', 'math', 'PyQt6.QtGui', 'threading', 'importlib', 'dynamic_settings_modules', 'PyQt6.QtWidgets', 'copy', 'queue', 'hashlib', 'subprocess', 'json', 'urllib.request', 'sys', 'os', 'save_prefs', 'dateutil.relativedelta', 'rectification_engine', 'warnings', 'main', 'pickle', 'dynamic_settings_modules.composite_strength_mod', 'timezonefinder', 'builtins', 'datetime'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
