...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['PyQt6.QtCore', 'warnings', 'copy', 'builtins', 'urllib.request', 'hashlib', 'sys', 'pickle', 'chart_renderer', 'PyQt6.QtWidgets', 'timezonefinder', 'traceback', 'math', 'urllib.error', 'json', 'os', 'astro_engine', 'dateutil.relativedelta', 'save_prefs', 'importlib', 'dynamic_settings_modules.composite_strength_mod', 'queue', 'dynamic_settings_modules', 'time', 'threading', 'swisseph', 'PyQt6.QtGui', 'rectification_engine', 'datetime', 'logging', 'main', 'subprocess'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
