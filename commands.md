...
pyinstaller --noconfirm --onedir --name "Astro Basics" --windowed --icon "icon.ico" --add-data "icon.ico;." --add-data "ephe;ephe" --add-data "dynamic_settings_modules;dynamic_settings_modules" --collect-data timezonefinder main.py
