...
def _get_varshaphala_marriage_triggers(jd, place, year, derived):
    ...
    patyayini_raw = patyayini.patyayini_dhasa(jd_years, place, divisional_chart_factor=1, chart_method=1)
...
if __name__ == "__main__":
    ...
    if SHOW_PVR_OUTPUT_FOR_VERIFICATION:
        ...
        pd = patyayini.patyayini_dhasa(jd_years, place, divisional_chart_factor=1)
