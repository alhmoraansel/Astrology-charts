...
from dynamic_settings_modules import shadbal_module
...
try:
    from dynamic_settings_modules import vishmottari_module
    AVAILABLE_RESEARCH_PLUGINS = [shadbal_module, vishmottari_module]
except ImportError:
